...
void movement_intent_system(ECS& ecs, const Entity& active_cam)
{
	...
	ecs.for_each_components<PlayerState, InputComponent, MovementIntent>(
	    [&](Entity& e, PlayerState& ps, InputComponent& ic, MovementIntent& intent) {
            ...
            intent.jump     = ic.jump;
            intent.sprint   = ic.sprint;
            intent.crouch   = ic.crouch;
