...
export {
  ...
  struct framebuffer_attachment {
	...
	struct RenderTarget {
		public:
			RenderTarget(u32 width, u32 height, std::initializer_list<framebuffer_attachment_desc> desc)
  ...
  class framebuffer {
    public:
      ...
      void create(u32 width, u32 height, std::span<const framebuffer_attachment_desc> attachments)
      {
    ...
    private:
      ...
      void move_from(framebuffer& other) {
        ...
        m_desc_attachments = std::move(other.m_desc_attachments);
