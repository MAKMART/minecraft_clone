...
bool SystemInterface::LogMessage(Rml::Log::Type type, const Rml::String& message) {
    const char* type_str = "";
    switch (type) {
	case Rml::Log::Type::LT_ALWAYS:   type_str = "ALWAYS"; break;
	case Rml::Log::Type::LT_ERROR:    type_str = "ERROR"; break;
	case Rml::Log::Type::LT_ASSERT:   type_str = "ASSERT"; break;
	case Rml::Log::Type::LT_WARNING:  type_str = "WARNING"; break;
	case Rml::Log::Type::LT_INFO:     type_str = "INFO"; break;
	case Rml::Log::Type::LT_DEBUG:    type_str = "DEBUG"; break;
    }
