...
unsigned int Shader::compileSingleShader(const std::string& code, GLenum shaderType)
{
...
unsigned int Shader::loadAndCompile(const std::filesystem::path& vertexPath, const std::filesystem::path& fragmentPath)
{
...
unsigned int Shader::loadAndCompile(const std::filesystem::path& computePath, ShaderType type)
{
